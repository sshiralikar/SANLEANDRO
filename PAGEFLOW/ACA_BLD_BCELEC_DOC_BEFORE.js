/*------------------------------------------------------------------------------------------------------/
| Program : ACA_BLD_BCELEC_DOC_BEFORE.js
...
function getProComplRequiredDocuments()
{
    ...
    if((String(AInfo["Plumbing?"]).toUpperCase() == "YES" || String(AInfo["Plumbing?"]).toUpperCase() == "Y")
        ...
        ||(String(AInfo["Lighting"]).toUpperCase() == "YES" || String(AInfo["Lighting"]).toUpperCase() == "Y" || String(AInfo["Lighting"]).toUpperCase() == "CHECKED")
    )
    ...
    if((String(AInfo["Main Panel"]).toUpperCase() == "YES" || String(AInfo["Main Panel"]).toUpperCase() == "Y" || String(AInfo["Main Panel"]).toUpperCase() == "CHECKED")
        ||(String(AInfo["Rewire"]).toUpperCase() == "YES" || String(AInfo["Rewire"]).toUpperCase() == "Y" || String(AInfo["Rewire"]).toUpperCase() == "CHECKED"))
    {
