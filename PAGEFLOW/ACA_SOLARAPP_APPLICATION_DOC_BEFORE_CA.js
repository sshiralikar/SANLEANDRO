/*------------------------------------------------------------------------------------------------------/
| Program : ACA_SOLARAPP_APPLICATION_DOC_BEFORE_CA.js
...
function getProComplRequiredDocuments()
{
	...
	requirementArray.push("SolarApp Approval");
	requirementArray.push("SolarApp Spec Sheets");
	requirementArray.push("Electric Line Diagram");
    requirementArray.push("Owner Acknowledgement Form");
