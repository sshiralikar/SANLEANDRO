...
function mainProccess() {
    ...
    for(var lpNum in lpsToLock) {
        ...
        var permitData = [];
        expiredPermits.forEach(function(altId) {
            ...
            addStdCondition("Engineering", "PINS Insurance Expired", capId);
            var result = aa.set.addCapSetMember("PINS_EXPIRED_INSURANCE", capId);
            if (result.getSuccess()) {
                logDebug("Successfully added " + altId + " to set");
            } else {
