if(!matches(currentUserGroup,"BuildingAdmin","BuildingDailyUser","BuildingSupervisorUser") && !matches(inspType,"Courtesy Inspection") && capStatus != "Issued")
{
    showMessage = true;
...
if(publicUser && !matches(inspType,"0008 Courtesy Inspection") && capStatus != "Issued")
{
    showMessage = true;
...
if(matches(inspType,"3000 Final - Building Permit")  && publicUser && appHasCondition(null,"Not Met",null,null))
{
    showMessage = true;
