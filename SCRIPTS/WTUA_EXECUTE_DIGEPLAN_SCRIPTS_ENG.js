//WTUA_EXECUTE_DIGEPLAN_SCRIPTS_ENG
logDebug("Inside WTUA_EXECUTE_DIGEPLAN_SCRIPTS_ENG");
...
var docTypeArrayModule = ["Construction Plans","Plans","Site Plans","Document","Supporting Documents","Other","Application Materials","Markups","Other Documents","Standard Plans","Sidewalk Repair Exhibit","Soils Reports","Traffic Control Plans","Sewer Repair Forms","OSHA Documents","Compaction Report"];

//Workflow Specific variables for PMT
var reviewTasksArray = ["FIRE REVIEW","BUILDING REVIEW","PLANNING REVIEW","ENVIRONMENTAL SVCS REVIEW","ENGINEERING REVIEW","PWSC REVIEW","IT REVIEW","TRAFFIC REVIEW"];
var taskStatusArray = ["APPROVED","DENIED"];
var routingTaskArray = ["Application Submittal"];
...
var reviewTaskResubmitStatusArray = ["Denied"];
var reviewTaskApprovedStatusArray = ["Approved"];
var reviewTaskStatusPendingArray = [null,"",undefined,"Notes","Revisions Received"];
var consolidationTask = "Permit Decision";
var consolidationResubmitStatusArray = ["Resubmittal"];
var consolidationApprovedStatus = "Issue";
var consolidationApprovedStatusArray = ["Issue","Issued"];
var readyToIssueTask = "Permit Decision";
var readyToIssueTaskStatusArray = ["Issue","Issued"];
var issueTask = "Permit Decision";
var issueStatusArray = ["Issue","Issued"];

//Workflow Specific variables for PMT
if(matches(wfProcess,"E_PRJ")) {
    var reviewTasksArray = ["FIRE REVIEW","BUILDING REVIEW","PLANNING REVIEW","ENVIRONMENTAL SVCS REVIEW","ENGINEERING REVIEW","PWSC REVIEW","IT REVIEW","TRAFFIC REVIEW"];
    var taskStatusArray = ["APPROVED","DENIED"];
    var routingTaskArray = ["Application Submittal"];
    var routingStatusArray = ["Route"];
    ...
    var reviewTaskApprovedStatusArray = ["Approved"];
    var reviewTaskStatusPendingArray = [null,"",undefined,"Notes","Revisions Received"];
    var consolidationTask = "Application Decision";
    var consolidationResubmitStatusArray = ["Resubmittal"];
    var consolidationApprovedStatus = "Received Recording Information";
    var consolidationApprovedStatusArray = ["Received Recording Information"];
    var readyToIssueTask = "Application Decision";
    var readyToIssueTaskStatusArray = ["Received Recording Information"];
    var issueTask = "Application Decision";
    var issueStatusArray = ["Received Recording Information"];
}
